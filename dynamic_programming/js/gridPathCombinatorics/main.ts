...
function optimalStackMemoize(dim1, dim2) {
	if (dim1 <= 2 || dim2 <= 2) {
	...
	let topSmallDim, topBigDim;

	if (oneOff) {
		return (
			optimalStackMemoize(dim1 - 1, dim2) +
			optimalStackMemoize(dim1, dim2 - 1)
		);
	}
	...
	if (!symmetric) {
		...
		topSmallDim = topDimsSorted[0];
		topBigDim = topDimsSorted[1];
	} else {
		topSmallDim = dim1;
		topBigDim = dim2;
	}
...
console.log("Tests using optimal stack memoization");
console.log("(0, 4) = " + optimalStackMemoize(0, 4)); //0
console.log("(1, 2) = " + optimalStackMemoize(1, 2)); //1
console.log("(2, 2) = " + optimalStackMemoize(2, 2)); //2
console.log("(2, 3) = " + optimalStackMemoize(2, 3)); //3
console.log("(3, 3) = " + optimalStackMemoize(3, 3)); //6
console.log("(4, 3) = " + optimalStackMemoize(4, 3)); //6
console.log("(3, 5) = " + optimalStackMemoize(3, 5)); //15
console.log("(6, 6) = " + optimalStackMemoize(6, 6)); //252
console.log("(5, 6) = " + optimalStackMemoize(5, 6)); //126
console.log("(5, 9) = " + optimalStackMemoize(5, 9)); //495
console.log("(4, 11) = " + optimalStackMemoize(4, 11)); //286
console.log("(10, 15) = " + optimalStackMemoize(10, 15)); //817190

console.log("Very large tests using optimal stack memoization");
console.log("(18, 18) = " + optimalStackMemoize(18, 18)); //2333606220
console.log("(14, 27) = " + optimalStackMemoize(14, 27)); //8122425444
console.log("(42, 41) = " + optimalStackMemoize(42, 41)); //2.1239229042439588e+23
