...
console.log(`\nThe answer for ('tpwx','tpwx') is ` + JSON.stringify(subsequenceMatch('small','tpwx','tpwx')) );
//[[0,1,2,3]]

console.log(`\nThe answer for ('tpwx','tpwxapplebwananacwherrypeachx') is ` + JSON.stringify(subsequenceMatch('small','tpwx','tpwxapplebwananacwherrypeachx')) );
//[[0,1,2,3],[0,1,2,28],[0,1,10,28],[0,1,17,28],[0,5,10,28],[0,5,17,28],[0,6,10,28],[0,6,17,28]]

console.log(`\nThe answer for ('tpwx','teflpawmvwsebx') is ` + JSON.stringify(subsequenceMatch('small','tpwx','teflpawmvwsebx')) );
//[[0,4,6,13],[0,4,9,13]]

console.log(`\nThe answer for ('xtpwx','xteflpawmvwsebx') is ` + JSON.stringify(subsequenceMatch('small','xtpwx','xteflpawmvwsebx')) );

console.log(`\nThe answer for ('xteflpawmvwsebx','xtpwx') is ` + JSON.stringify(subsequenceMatch('small','xteflpawmvwsebx','xtpwx')) );
//[[0,1,5,7,14],[0,1,5,10,14]]

console.log(`\nThe answer for ('aaa','aaaaaaa') is ` + JSON.stringify(subsequenceMatch('small','aaa','aaaaaaa')) );
...
console.log(`\nThe answer for ('aaaaaaa','aaaaaaaaaaaaaaaa') contains ` + subsequenceMatch('large','aaaaaaa','aaaaaaaaaaaaaaaa') + ' matches');
//11440 matches
