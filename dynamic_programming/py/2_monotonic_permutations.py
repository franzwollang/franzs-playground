...
# Alternative description: compute the size of the set of all strictly monotonic permutations of the natural numbers such that their sum equals some value 'n' and the magnitude of the set is greater than 1.
...
def step_loop(memo, step, free_blocks, h_max = None):
    # print('step_loop called:')
    # print(step, free_blocks, h_max)
    ...
    for height in range(h_max, step-1, -1):
        # print("step", step, "height", height)
        used_blocks = height - step
        remainder = free_blocks - used_blocks

        if remainder < 0:
            # print("remainder less than 0")
...
# print(f"monotonic_permutations(3) returns {monotonic_permutations(3)}; it should return 1")

# print(f"monotonic_permutations(5) returns {monotonic_permutations(5)}; it should return 2")

# print(f"monotonic_permutations(6) returns {monotonic_permutations(6)}; it should return 3")

# print(f"monotonic_permutations(10) returns {monotonic_permutations(10)}; it should return 9")

print(f"monotonic_permutations(15) returns {monotonic_permutations(15)}; it should return 26")
# loop for 4 steps should be 6, not 7
# loop for 4 steps should be 12?, not 16
# counting duplicate cases?

# print(f"monotonic_permutations(25) returns {monotonic_permutations(25)}; it should return 141")

# print(f"monotonic_permutations(50) returns {monotonic_permutations(50)}; it should return 3657")

# print(f"monotonic_permutations(200) returns {monotonic_permutations(200)}; it should return 487067745")
...
# print(f"solution(10) returns {solution(10)}; it should return 9")

# print(f"solution(15) returns {solution(15)}; it should return 26")

# print(f"solution(25) returns {solution(25)}; it should return 141")